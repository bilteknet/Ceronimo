<?php
	...
	$mcImageManagerConfig['filesystem.rootpath'] = '/srv/www/ceronimo.com/public_html/haber/static/content/photos/news'; // absolute or relative from this script path, required.
