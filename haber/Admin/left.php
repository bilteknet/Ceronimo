	...
	<body><div id="body-wrapper"> <!-- Wrapper for the radial gradient background -->
		...
		<div id="sidebar"><div id="sidebar-wrapper"> <!-- Sidebar with logo and menu -->
			...
			<div id="profile-links">
				...
				<a href="#" title="View the Site">Siteye Git</a> | <a href="#" title="Sign Out">Çikis</a>
			</div>        
			...
			<ul id="main-nav">  <!-- Accordion Menu -->
				...
				<li> 
					...
					<ul>
						<li><a href="#">Yeni Yazi Ekle</a></li>
						<li><a href="#">Yazilari Düzenle</a></li> <!-- Add class "current" to sub menu items also -->
						<li><a href="#">Yazi Yerlesimi</a></li>
						<li><a href="#">Onay Bekleyen Yazilar</a></li>
					</ul>
				</li>
